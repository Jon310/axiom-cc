...
namespace Axiom.Helpers
{
    class CombatLog : LuaEventArgs
    {
        ...
        public WoWUnit SourceUnit
        {
            get
            {
                WoWGuid cachedSourceGuid = SourceGuid.IsValid ? SourceGuid: Helpers.Spell.LastCastTarget.Guid;
                return
        ...
        public WoWUnit DestUnit
        {
            get
            {
                ...
                return
                    ObjectManager.GetObjectsOfType<WoWUnit>(true, true).FirstOrDefault(
                        o => o.IsValid && (o.Guid == cachedDestGuid || o.DescriptorGuid == cachedDestGuid)) ?? Helpers.Spell.LastCastTarget;
            }
        }
